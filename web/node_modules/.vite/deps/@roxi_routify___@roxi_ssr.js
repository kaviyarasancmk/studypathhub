...
var e, t, i, s, a, o, l, h, d, m, g, y, x, E, b, v, S, A, I, P, M, D, L, V, B, F, z, j, U, G, H, W, q, K, X, Y, Q, J, Z, ee, te, ie, se, ne, ue, me, we, Ce, _e, $e, Te, Oe, Le, Ve, Be, Fe, ze, je, Ue, Ge, He, We, qe, Ke, Xe, et, tt, it, nt, rt, lt, ct, ut, dt, pt, ft, mt, gt, yt, xt, Et, bt, vt, St, At, It, Pt, kt, wt, Ct, _t, Nt, $t, Tt, Ot, Rt, Mt, Dt, Bt, Ft, zt, jt, Gt, Ht, Wt, qt, Kt, Xt, Yt, Qt, Jt, Zt, ei, ii, si, ni, li, ci, gi, yi, xi, Ei, bi, vi, Pi, ki, wi, Ci, _i, Ni, Ti, Mi, Li, Vi, Bi, Fi, zi, ji, Ui, Gi, Hi, Wi, qi, Ki, Xi, Yi, Qi, Ji, Zi, es, ts, is, ss, ns, rs, as, os, ls, hs, cs, us, ds, ps, fs, ms, gs, ys, bs, vs, Ss, As, Is, Ps, ks, ws, Cs, _s, Ns, $s, Ts, Os, Rs, Ms, Ds, Ls, Bs, Fs, zs, js, Us, Gs, Ws, qs, Ks, Xs, en, tn, sn, an, ln, cn, yn, bn, Sn, Pn, kn, wn, Cn, Nn, $n, On, Rn, Mn, Vn, Bn, zn, jn, Un, Kn, Xn, Yn, Jn, Zn, sr, nr, rr, ar, or, lr, hr, cr, ur, dr, pr, fr, mr, gr, yr, Er, br, vr, Sr, kr, wr, Cr, Rr, Mr, Vr, Fr, jr, Ur, Gr, qr, Xr, Yr, Qr, ea, ta, ia, sa, na, ra, aa, oa, la, da, fa, ma, ga, xa, Ea, ba, Aa, Ia, Pa, ka, wa, Ca, _a, Ta, Oa, Ra, Da, La, Fa, za, ja, Ua, Ga, Ha, Wa, qa, Ka, Xa, Ya, Za, eo, to, io, so, ro, ao, oo, lo, ho, co, po, fo, mo, go, yo, xo, Eo, bo, vo, So, Ao, Po, ko, wo, Co, Lo, Vo, Fo, zo, jo, Ho, Wo, Xo, el, rl, hl, cl, ml, gl, El, vl, Sl, Al, Il, Pl, kl, wl, Cl, _l, Nl, $l, Tl, Ol, Rl, Ml, Dl, Ll, Vl, Bl, Fl, jl, Ul, Gl, Hl, Wl, ql, Kl, Xl, Yl, Ql, Jl, eh, th, ih, sh, nh, rh, ah, oh, dh;
var init_rollup_browser = __esm({
  "node_modules/rollup/dist/es/rollup.browser.js"() {
    ...
    I = /[/\\]/;
    P = /\.[^.]+$/;
    M = Symbol("Unknown Key");
    D = Symbol("Unknown Non-Accessor Key");
    L = Symbol("Unknown Integer");
    V = [];
    B = [M];
    F = [D];
    z = [L];
    ...
    Y = { thisArg: null, type: 0 };
    Q = { args: [X], thisArg: null, type: 1 };
    J = [];
    Z = { args: J, thisArg: null, type: 2, withNew: false };
    ee = class extends K {
      constructor(e) {
    ...
    ie = Object.freeze(/* @__PURE__ */ Object.create(null));
    se = Object.freeze({});
    ne = Object.freeze([]);
    ue = /^(\.\.\/)*\.\.$/;
    !function(e) {
    ...
    we = /* @__PURE__ */ new Set(["await", "break", "case", "catch", "class", "const", "continue", "debugger", "default", "delete", "do", "else", "enum", "eval", "export", "extends", "false", "finally", "for", "function", "if", "implements", "import", "in", "instanceof", "interface", "let", "NaN", "new", "null", "package", "private", "protected", "public", "return", "static", "super", "switch", "this", "throw", "true", "try", "typeof", "undefined", "var", "void", "while", "with", "yield"]);
    Ce = /[^$_a-zA-Z0-9]/g;
    _e = (e) => ((e2) => /\d/.test(e2[0]))(e) || we.has(e) || "arguments" === e;
    $e = class {
    ...
    Le = new class extends K {
      getLiteralValueAtPath() {
      }
    }();
    Ve = { value: { hasEffectsWhenCalled: null, returns: X } };
    ...
    Fe = { value: { hasEffectsWhenCalled: null, returns: Be } };
    ze = new class extends K {
      getReturnExpressionWhenCalledAtPath(e) {
    ...
    je = { value: { hasEffectsWhenCalled: null, returns: ze } };
    Ue = new class extends K {
      getReturnExpressionWhenCalledAtPath(e) {
    ...
    tt = "sourceMa";
    tt += "ppingURL";
    it = new RegExp("^#[ \\f\\r\\t\\v\\u00a0\\u1680\\u2000-\\u200a\\u2028\\u2029\\u202f\\u205f\\u3000\\ufeff]+sourceMappingURL=.+");
    nt = /[^\s(]/g;
    rt = /\S/g;
    lt = /[@#]__PURE__/;
    ct = { Literal: [], Program: ["body"] };
    ut = class extends K {
      constructor(e, t, i) {
    ...
    ft = [new pt({ callsArgs: null, mutatesSelfAsArray: false, returns: null, returnsPrimitive: Be })];
    mt = [new pt({ callsArgs: null, mutatesSelfAsArray: false, returns: null, returnsPrimitive: Ue })];
    gt = [new pt({ callsArgs: null, mutatesSelfAsArray: false, returns: null, returnsPrimitive: ze })];
    yt = [new pt({ callsArgs: null, mutatesSelfAsArray: false, returns: null, returnsPrimitive: X })];
    xt = /^\d+$/;
    Et = class extends K {
    ...
    bt = (e) => "string" == typeof e && /^\d+$/.test(e);
    vt = new class extends K {
      deoptimizeThisOnInteractionAtPath({ type: e, thisArg: t }, i) {
    ...
    St = new Et({ __proto__: null, hasOwnProperty: ft, isPrototypeOf: ft, propertyIsEnumerable: ft, toLocaleString: mt, toString: mt, valueOf: yt }, vt, true);
    At = [{ key: L, kind: "init", property: X }, { key: "length", kind: "init", property: ze }];
    It = [new pt({ callsArgs: [0], mutatesSelfAsArray: "deopt-only", returns: null, returnsPrimitive: Be })];
    Pt = [new pt({ callsArgs: [0], mutatesSelfAsArray: "deopt-only", returns: null, returnsPrimitive: ze })];
    kt = [new pt({ callsArgs: null, mutatesSelfAsArray: true, returns: () => new Et(At, Mt), returnsPrimitive: null })];
    wt = [new pt({ callsArgs: null, mutatesSelfAsArray: "deopt-only", returns: () => new Et(At, Mt), returnsPrimitive: null })];
    Ct = [new pt({ callsArgs: [0], mutatesSelfAsArray: "deopt-only", returns: () => new Et(At, Mt), returnsPrimitive: null })];
    _t = [new pt({ callsArgs: null, mutatesSelfAsArray: true, returns: null, returnsPrimitive: ze })];
    Nt = [new pt({ callsArgs: null, mutatesSelfAsArray: true, returns: null, returnsPrimitive: X })];
    $t = [new pt({ callsArgs: null, mutatesSelfAsArray: "deopt-only", returns: null, returnsPrimitive: X })];
    Tt = [new pt({ callsArgs: [0], mutatesSelfAsArray: "deopt-only", returns: null, returnsPrimitive: X })];
    Ot = [new pt({ callsArgs: null, mutatesSelfAsArray: true, returns: "self", returnsPrimitive: null })];
    Rt = [new pt({ callsArgs: [0], mutatesSelfAsArray: true, returns: "self", returnsPrimitive: null })];
    Mt = new Et({ __proto__: null, at: $t, concat: wt, copyWithin: Ot, entries: wt, every: It, fill: Ot, filter: Ct, find: Tt, findIndex: Pt, findLast: Tt, findLastIndex: Pt, flat: wt, flatMap: Ct, forEach: Tt, group: Tt, groupToMap: Tt, includes: ft, indexOf: gt, join: mt, keys: yt, lastIndexOf: gt, map: Ct, pop: Nt, push: _t, reduce: Tt, reduceRight: Tt, reverse: Ot, shift: Nt, slice: wt, some: It, sort: Rt, splice: kt, toLocaleString: mt, toString: mt, unshift: _t, values: $t }, St, true);
    Dt = class extends ee {
      constructor(e, t, i, s) {
    ...
    si = { __proto__: null, class: true, const: true, let: true, var: true };
    ni = class extends ut {
      constructor() {
    ...
    Ni = { "!=": (e, t) => e != t, "!==": (e, t) => e !== t, "%": (e, t) => e % t, "&": (e, t) => e & t, "*": (e, t) => e * t, "**": (e, t) => e ** t, "+": (e, t) => e + t, "-": (e, t) => e - t, "/": (e, t) => e / t, "<": (e, t) => e < t, "<<": (e, t) => e << t, "<=": (e, t) => e <= t, "==": (e, t) => e == t, "===": (e, t) => e === t, ">": (e, t) => e > t, ">=": (e, t) => e >= t, ">>": (e, t) => e >> t, ">>>": (e, t) => e >>> t, "^": (e, t) => e ^ t, "|": (e, t) => e | t };
    Ti = class extends ut {
    ...
    es = { auto: "_interopDefault", default: null, defaultOnly: null, esModule: null, false: null, true: "_interopDefaultLegacy" };
    ts = (e, t) => "esModule" === e || t && ("auto" === e || "true" === e);
    ...
    ss = (e, t) => ts(e, t) && "_interopDefault" === es[e];
    ns = (e, t, i, s, n2, r2, a2) => {
      const o2 = new Set(e);
      for (const e2 of ys)
        t.has(e2) && o2.add(e2);
    ...
    as = ({ _: e, getObject: t }) => `e${e}:${e}${t([["default", "e"]], { lineBreakIndent: null })}`;
    os = ({ _: e, getPropertyAccess: t }) => `e${t("default")}${e}:${e}e`;
    ls = (e, t, i, s, n2, r2) => {
    ...
    hs = (e, t, { _: i, cnst: s, getFunctionIntro: n2, s: r2 }) => "var" !== s || t ? `for${i}(${s} k in e)${i}${e}` : `Object.keys(e).forEach(${n2(["k"], { isAsync: false, name: null })}${e})${r2}`;
    cs = (e, t, i, { _: s, cnst: n2, getDirectReturnFunction: r2, getFunctionIntro: a2, n: o2 }) => {
      if (t) {
    ...
    fs = (e, t, { _: i, n: s }) => `${t}n[k]${i}=${i}e[k];${s}`;
    ms = (e, t) => e ? `Object.freeze(${t})` : t;
    gs = (e, t, { _: i, getObject: s }) => e ? `Object.defineProperty(${t},${i}Symbol.toStringTag,${i}${xs(s)})` : t;
    ys = Object.keys(rs);
    bs = { amd: ["require"], cjs: ["require"], system: ["module"] };
    vs = "ROLLUP_ASSET_URL_";
    Ss = "ROLLUP_FILE_URL_";
    As = { amd: ["document", "module", "URL"], cjs: ["document", "require", "URL"], es: [], iife: ["document", "URL"], system: ["module"], umd: ["document", "require", "URL"] };
    Is = { amd: ["document", "require", "URL"], cjs: ["document", "require", "URL"], es: [], iife: ["document", "URL"], system: ["module", "URL"], umd: ["document", "require", "URL"] };
    Ps = (e, t = "URL") => `new ${t}(${e}).href`;
    ks = (e, t = false) => Ps(`'${e}', ${t ? "typeof document === 'undefined' ? location.href : " : ""}document.currentScript && document.currentScript.src || document.baseURI`);
    ws = (e) => (t, { chunkId: i }) => {
      const s = e(i);
      return null === t ? `({ url: ${s} })` : "url" === t ? s : "undefined";
    };
    Cs = (e, t = false) => `${t ? "typeof document === 'undefined' ? location.href : " : ""}(document.currentScript && document.currentScript.src || new URL('${e}', document.baseURI).href)`;
    _s = { amd: (e) => ("." !== e[0] && (e = "./" + e), Ps(`require.toUrl('${e}'), document.baseURI`)), cjs: (e) => `(typeof document === 'undefined' ? ${Ps(`'file:' + __dirname + '/${e}'`, "(require('u' + 'rl').URL)")} : ${ks(e)})`, es: (e) => Ps(`'${e}', import.meta.url`), iife: (e) => ks(e), system: (e) => Ps(`'${e}', module.meta.url`), umd: (e) => `(typeof document === 'undefined' && typeof location === 'undefined' ? ${Ps(`'file:' + __dirname + '/${e}'`, "(require('u' + 'rl').URL)")} : ${ks(e, true)})` };
    Ns = { amd: ws(() => Ps("module.uri, document.baseURI")), cjs: ws((e) => `(typeof document === 'undefined' ? ${Ps("'file:' + __filename", "(require('u' + 'rl').URL)")} : ${Cs(e)})`), iife: ws((e) => Cs(e)), system: (e, { snippets: { getPropertyAccess: t } }) => null === e ? "module.meta" : `module.meta${t(e)}`, umd: ws((e) => `(typeof document === 'undefined' && typeof location === 'undefined' ? ${Ps("'file:' + __filename", "(require('u' + 'rl').URL)")} : ${Cs(e, true)})`) };
    $s = class extends ut {
      constructor() {
    ...
    Ls = { "!": (e) => !e, "+": (e) => +e, "-": (e) => -e, delete: () => W, typeof: (e) => typeof e, void: () => {
    }, "~": (e) => ~e };
    Bs = class extends ut {
      deoptimizePath() {
        for (const e of this.declarations)
    ...
    Fs = { ArrayExpression: class extends ut {
      constructor() {
        super(...arguments), this.objectEntity = null;
      }
      deoptimizePath(e) {
    ...
    Ws = "performance" in ("undefined" != typeof globalThis ? globalThis : "undefined" != typeof window ? window : {}) ? performance : { now: () => 0 };
    qs = { memoryUsage: () => ({ heapUsed: 0 }) };
    Ks = () => {
    };
    Xs = /* @__PURE__ */ new Map();
    en = Ks;
    tn = Ks;
    sn = ["load", "resolveDynamicImport", "resolveId", "transform"];
    an = { identifier: null, localName: "_missingExportShim" };
    ln = class {
    ...
    cn = (e) => e && new Map(Array.from(e, ([e2, t]) => [e2, new Set(t)]));
    yn = (e, t, i, { _: s, getDirectReturnFunction: n2, n: r2 }) => {
      if (t) {
    ...
    bn = { assert: true, buffer: true, console: true, constants: true, domain: true, events: true, http: true, https: true, os: true, path: true, process: true, punycode: true, querystring: true, stream: true, string_decoder: true, timers: true, tty: true, url: true, util: true, vm: true, zlib: true };
    Sn = (e, t) => e.split(".").map(t).join("");
    Pn = ({ dependencies: e, exports: t }) => {
    ...
    kn = (e, t, { _: i, cnst: s, getObject: n2, n: r2 }) => e ? `${r2}${t}${s} _starExcludes${i}=${i}${n2([...e].map((e2) => [e2, "1"]), { lineBreakIndent: { base: t, t } })};` : "";
    wn = (e, t, { _: i, n: s }) => e.length ? `${s}${t}var ${e.join(`,${i}`)};` : "";
    Cn = (e, t, i) => _n(e.filter((e2) => e2.hoisted).map((e2) => ({ name: e2.exported, value: e2.local })), t, i);
    Nn = (e, t, i) => _n(e.filter((e2) => e2.expression).map((e2) => ({ name: e2.exported, value: e2.local })), t, i);
    $n = (e, t, i) => _n(e.filter((e2) => "_missingExportShim" === e2.local).map((e2) => ({ name: e2.exported, value: "_missingExportShim" })), t, i);
    On = { amd: function(e, { accessedGlobals: t, dependencies: i, exports: s, hasExports: n2, id: r2, indent: a2, intro: o2, isEntryFacade: l2, isModuleFacade: h2, namedExportsMode: c2, outro: u2, snippets: d2, warn: p2 }, { amd: f2, esModule: m2, externalLiveBindings: g2, freeze: y2, interop: x2, namespaceToStringTag: E2, strict: b2 }) {
      vn(p2, i);
    ...
    br = Er;
    vr = () => br();
    Sr = { amd: Pr, cjs: Pr, es: Ir, iife: Pr, system: Ir, umd: Pr };
    kr = /[\\'\r\n\u2028\u2029]/;
    wr = /(['\r\n\u2028\u2029])/g;
    Cr = /\\/g;
    Rr = Symbol("bundleKeys");
    Mr = { type: "placeholder" };
    Vr = [".js", ".jsx", ".ts", ".tsx"];
    Fr = class {
...
${t}` : e;
    qr = (e, t) => e.execIndex > t.execIndex ? 1 : -1;
    Xr = (e, t) => t ? `(${e})` : e;
    Yr = /^(?!\d)[\w$]+$/;
    Qr = class {
      constructor(e, t, i, s, n2) {
...
${r2}`), i2.length && (i2 += "\n"), s2.length && (s2 = "\n" + s2), { banner: i2, footer: s2, intro: n3, outro: r2 };
    ...
    za = { inFunction: { configurable: true }, inGenerator: { configurable: true }, inAsync: { configurable: true }, canAwait: { configurable: true }, allowSuper: { configurable: true }, allowDirectSuper: { configurable: true }, treatFunctionsAsVar: { configurable: true }, allowNewDotTarget: { configurable: true }, inClassStaticBlock: { configurable: true } };
    ...
    eo = function(e, t, i, s, n2) {
      this.token = e, this.isExpr = !!t, this.preserveSpace = !!i, this.override = s, this.generator = !!n2;
    };
    to = { b_stat: new eo("{", false), b_expr: new eo("{", true), b_tmpl: new eo("${", false), p_stat: new eo("(", false), p_expr: new eo("(", true), q_tmpl: new eo("`", true, true, function(e) {
    ...
    jo = { mkdir: zo("fs.mkdir"), readFile: zo("fs.readFile"), writeFile: zo("fs.writeFile") };
    Ho = [{ active: true, deprecated: "resolveAssetUrl", replacement: "resolveFileUrl" }];
    Wo = { delete: () => false, get() {
    }, has: () => false, set() {
    } };
    Xo = class {
    ...
    hl = Object.keys({ buildEnd: 1, buildStart: 1, closeBundle: 1, closeWatcher: 1, load: 1, moduleParsed: 1, options: 1, resolveDynamicImport: 1, resolveId: 1, shouldTransformCachedModule: 1, transform: 1, watchChange: 1 });
    cl = class {
      constructor(e, t, i, s, n2) {
    ...
    kl = (e) => ({ allowAwaitOutsideFunction: true, ecmaVersion: "latest", preserveParens: false, sourceType: "module", ...e.acorn });
    wl = (e) => yl(e.acornInjectPlugins);
    Cl = (e) => {
      var t;
    ...
    ih = /* @__PURE__ */ new Set(["auto", "esModule", "default", "defaultOnly", true, false]);
    sh = (e, t) => {
...
var require_ssr = __commonJS({
  "node_modules/@roxi/ssr/ssr.js"(exports, module) {
    ...
    module.exports.ssr = async function ssr(template, script, url, options) {
      ...
      script = inlineDynamicImports ? await resolveScript(script) : existsSync(script) ? readFileSync(script, "utf8") : script;
      return new Promise(async (resolve2, reject) => {
        try {
          let resolveHtml2 = function() {
            afterEval(dom);
          ...
          var resolveHtml = resolveHtml2;
          const dom = await new JSDOM(template, { runScripts: "outside-only", url: host + url });
          shimDom(dom);
          if (eventName) {
            dom.window.addEventListener(eventName, resolveHtml2);
    ...
    async function resolveScript(script) {
      ...
      if (!existsSync(bundlePath)) {
        const bundle = await (init_rollup_browser(), __toCommonJS(rollup_browser_exports)).rollup({
          input: script,
...
*/
//# sourceMappingURL=@roxi_routify___@roxi_ssr.js.map
