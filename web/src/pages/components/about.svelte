...
<main class="p-4">
  ...
  <div class="p-4 mt-8">
    <h2 class="text-3xl md:text-4xl font-semibold mb-4">Our Goals</h2>
    <ul class="list-disc list-inside md:list-outside ml-8">
      {#each projectGoals as goal (goal)}
        <li class="text-lg md:text-xl mb-2">{goal}</li>
      {/each}
    </ul>
  </div>
</main>
