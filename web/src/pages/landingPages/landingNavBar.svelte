...
<nav class="m-0 landingnavBar w-full h-10">
  <ul class="w-full h-full flex items-center justify-between">
    <li class="{landingNavButton} {centerButton}">
      <svg
        viewBox="0 0 24 24"
        class="w-6 h-6"
        fill="none"
      ...
      <a href="/" class={landingNavLink}> Home </a>
    </li>
    <li class="{landingNavButton} {centerButton}">
      <svg
        fill="#000000"
      ...
      <a href="/components/careerResources" class={landingNavLink}>
        Resources
      </a>
    </li>
    <li class="{landingNavButton} {centerButton}">
      ...
      <a href="/components/blog" class={landingNavLink}> Our Blogs </a>
    </li>
    <li class="{landingNavButton} {centerButton}">
      <svg
        viewBox="0 0 24 24"
      ...
      <a href="/components/knowMoreAs" class={landingNavLink}> Know More Us </a>
    </li>
    <li class="{landingNavButton} {centerButton}">
      <svg
        viewBox="0 -1.5 21 21"
      ...
      <a href="/components/signup" class={landingNavLink}> Join With Us </a>
    </li>
  </ul>
</nav>
...
<style>
  .landingnavBar {
    ...
    box-shadow: 0px 6px 4px 0px #3b82f6;
  }
  .landingNavLink {
    color: white;
  }
